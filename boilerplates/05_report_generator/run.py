"""Report Generator — Real Mode. Requires LLM_API_KEY."""
...
async def main():
    ...
    ).run({"task": "Analyse Q1 2026 sales data and generate a board report.",
           "tenant_id": "your-org", "user_id": "finance-director",
