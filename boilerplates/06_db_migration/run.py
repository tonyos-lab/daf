"""DB Migration Validator — Real Mode. Requires LLM_API_KEY."""
...
async def main():
    ...
    ).run({"task": "Validate the latest database migration script and produce a risk report.",
           "tenant_id": "your-org", "user_id": "dba-lead"})
